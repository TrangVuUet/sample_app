class User < ActiveRecord::Base
  ...
  has_many :followers, through: :passive_relationships, source: :follower
	...
	# Remembers a user in the db
	def remember
	  self.remember_token = User.new_token
	  update_attribute(:remember_digest, User.digest(remember_token))
	end

	# Refactor and returns true if the given token matches the digest
	...
	# Save the reset digest into the database
	...
	# Define feed
	def feed
		# View posts of others and her own
